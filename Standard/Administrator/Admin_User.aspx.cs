    ...
    public partial class Admin_User : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!IsPostBack)
            {
                ...
                {
                    Response.Redirect("../Administrator/Admin_User_PIC.aspx");
                }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Admin_Search_Users", con);
        ...
        protected void GV_User_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string fullname = (GV_User.Rows[e.RowIndex].FindControl("txt_fullname") as TextBox).Text.Trim();
        ...
        protected void GV_User_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "AddNew")
                {
                    ...
                    string fullname = (GV_User.FooterRow.FindControl("txt_fullnamefooter") as TextBox).Text.Trim();
            ...
            catch (Exception ex)
            {
                ...
                alert.Attributes.CssStyle.Add("class", "text-danger");
            }
