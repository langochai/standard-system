<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Admin_User_PIC.aspx.cs" Inherits="Standard.Administrator.Admin_User_PIC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <div  class="row"   >
                    <div class="col-lg-12" >
                        <asp:Label ID="lbl_class" runat="server" Text="(STDADMINURPIC)"></asp:Label>
    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <asp:GridView ID="GV_User" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="user_id" SortExpression="user_id">
                       <%-- <EditItemTemplate>
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txt_userfooter" runat="server"></asp:TextBox>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="password" SortExpression="password">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txt_passfooter" runat="server"></asp:TextBox>
                        </FooterTemplate>
                    </asp:TemplateField>
           ...
           <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:StandardConnectionString %>" SelectCommand="select *from Permit_mst where permit >3 order by permit desc"></asp:SqlDataSource> 
