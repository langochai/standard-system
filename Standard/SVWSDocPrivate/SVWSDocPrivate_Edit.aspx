<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="SVWSDocPrivate_Edit.aspx.cs" Inherits="Standard.SVWSDocPrivate.SVWSDocPrivate_Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" >
                    <div class="col-lg-12" >
                        <asp:Label ID="lbl_class" runat="server" Text="(STDSVWSDPEdit)"></asp:Label>
                        <ol class="breadcrumb" style="background-color:#2E8A56; color:white; height:40px;">
                            ...
                            <li style="padding-top:9px;"><i ></i>
                                <%Response.Write(Standard.Language.value == "en" ? "Add New" : "Chỉnh sửa"); %>
                            </li>
    ...
    <div>
        <h4> 
            <% Response.Write(Standard.Language.value == "en" ? "Create Document" : "Chỉnh sửa tài liệu"); %>
        </h4>
