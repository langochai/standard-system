<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="SVWSDocument_edit.aspx.cs" Inherits="Standard.SVWSDocument.SVWSDocument_edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" >
                    <div class="col-lg-12" >
                        <asp:Label ID="lbl_class" runat="server" Text="(STDSVWSVDEdit)"></asp:Label>
    ...
    <div>
        <h4> 
            <% Response.Write(Standard.Language.value == "en" ? "Create Document" : "Tạo mới tài liệu"); %>
        </h4>
        <div style="font-style:italic">
            <span>
                <%Response.Write(Standard.Language.value == "en" ? "Items (*) are required" : "Những mục đánh dấu (*) là bắt buộc"); %>
            </span>
            ...
            <table style="width:100%">
                <tr style="padding:5px;">
                    <td class="content_col" >
                        <% Response.Write(Standard.Language.value == "en" ? "Document code*" : "Mã số*"); %>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="content_col">
                        <% Response.Write(Standard.Language.value == "en" ? "Ver*" : "Ver*"); %>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="content_col">
                        <%Response.Write(Standard.Language.value == "en" ? "Section Make*" : "Bộ phận lập*"); %>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <%--<textarea id="txt_des_vi" runat="server" rows="6" style="width:100%"></textarea>--%>
                        <%--<div runat="server" id="txt_des_vi" contenteditable="true"></div>--%>
