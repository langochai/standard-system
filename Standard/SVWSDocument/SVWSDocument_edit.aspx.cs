...
{
    public partial class SVWSDocument_edit : System.Web.UI.Page
    {
        ...
        void load_infor(string doc_id)
        {
            ...
            txt_title_vi.Text = dt.Rows[0]["svws_std_nm_vi"].ToString();
            txt_title_en.Text = dt.Rows[0]["svws_std_nm_eng"].ToString();
            txt_doc_c.Text = dt.Rows[0]["svws_std_c"].ToString();
            ...
            txt_ver.Text = dt.Rows[0]["svws_std_ver"].ToString();

            txt_des_vi.Text = (dt.Rows[0]["detail_vi"].ToString()).Replace("<br/>", "\n"); 
            txt_des_en.Text = dt.Rows[0]["detail_eng"].ToString();
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SVWS_updateDoc", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@svws_doc_id", Request.QueryString["doc_id"]);
            cmd.Parameters.AddWithValue("@svws_std_c", txt_doc_c.Text);
            cmd.Parameters.AddWithValue("@svws_std_ver", txt_ver.Text);
            cmd.Parameters.AddWithValue("@svws_std_nm_vi", txt_title_vi.Text);
            cmd.Parameters.AddWithValue("@svws_std_nm_eng", txt_title_en.Text);
